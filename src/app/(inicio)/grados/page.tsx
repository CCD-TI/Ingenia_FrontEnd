...
const Grado = () => {
  return (
    ...
    <div className="flex flex-col  w-full  ">
      ...
      <div className="max-w-[100rem]  flex flex-col items-center  justify-center">
      <div className="flex flex-wrap justify-center items-center lg:gap-[14rem] w-full mt-[4rem] max-sm:flex-col max-sm:gap-3 md:gap-12 mb-16">
...
>
  ...
  <div className="w-full sm:w-[600px] max-sm:w-[90%] h-auto sm:h-[559px] bg-white rounded-xl overflow-hidden border-2 border-[#F9B233] shadow-[0_0_15px_0_#F9B233]">
    <Image
...
>
  ...
  <div className="w-full sm:w-[600px] max-sm:w-[90%] h-auto sm:h-[559px] bg-white rounded-xl overflow-hidden border-2 border-[#179EC1] shadow-[0_0_20px_0_#179EC1]">
    <Image
