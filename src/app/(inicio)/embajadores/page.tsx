    ...
    return (
        <>
            <div className="bg-[url('/img/estudio.jpg')] bg-cover bg-center w-full  flex items-center justify-center  relative h-[850px]  max-xl:h-full   ">
                ...
                <div className='  flex max-xl:flex-col gap-10  px-6  max-sm:px-3 lg:mt-44  sm:mt-36 max-sm:flex-col max-sm:gap-0 py-10 '>

                    <div className='flex flex-col gap-1 text-white text-9xl font-poppins font-black pl-16 max-sm:pl-10 lg:pl-36  max-sm:mt-24 leading-[0.6] lg:leading-[0.8]
                            max-lg:text-7xl  md:text-8xl max-sm:text-6xl sm:text-7xl  lg:text-8xl max-sm:justify-center sm:justify-center 
                            '>

                        <h1 className='drop-shadow-[0_0_15px_rgba(255,255,255,1)] max-2xl:text-6xl max-sm:text-4xl '>AUMENTA EL</h1>

                        <div className='drop-shadow-[0_0_15px_rgba(255,255,255,1)] max-2xl:text-6xl max-sm:text-4xl '>POTENCIAL</div>

                        <div className='max-2xl:text-6xl max-sm:text-4xl    flex flex-col gap-1 text-yellowIngenia text-8xl font-black max-lg:text-6xl max-md:text-5xl '>
                            DE LA FUTURA
                            <div className='leading-[0.9] max-2xl:text-6xl max-sm:text-4xl '>
                                GENERACIÓN
                            </div>
                        </div>

                        <button className="text-[30px] font-semibold flex  gap-1 mt-28 max-lg:text-2xl max-md:text-xl max-sm:text-xl 
                         max-lg:mt-20 max-md:mt-8 
                    ...
                    <div className=' flex flex-col items-center'>
                        ...
                        <div className=' bg-[#918585a1] bg-opacity-60 rounded-[50px] w-[750px] h-[400px] max-2xl:w-[500px] max-sm:w-full  backdrop-blur-sm mb-4 max-sm:rounded-3xl 
                    max-sm:py-5 shadow-[0_0_55px_#06b6d4] max-sm:mt-12'>


                        </div>
                        <div className='  flex flex-col items-center gap-7 max-[400px]:flex-col max-[400px]:gap-4'>
                            <h1 className='text-white text-3xl max-2xl:text-2xl text-center'>¡Forma parte de nuestros embajadores!</h1>
            ...
            <div id="interesado-formar-parte" className="bg-[url('/img/fondo_embajadores.jpg')] h-full">
                ...
                <div className='flex flex-wrap items-start gap-80 [1050px]:gap-2 max-[900px]:gap-2 sm:gap-3  max-w-[100rem]  mx-auto  w-[80%] h-full '>
                    ...
                    <div className='bg-white p-6 rounded-2xl  mb-8 lg:mt-28  drop-shadow-[0_0_30px_rgba(255,255,255,2)]  md:ml-14'>
                        ...
                        <div className='flex max-sm:flex-col  items-center gap-8 mt-6'>
                        ...
                        <div className='mt-6'>
                            <p className='border border-gray-300 py-2 pl-4 w-fit max-sm:w-full flex items-center gap-2 text-gray-600 font-light rounded-lg hover:border-cyan-500 focus:ring-2 focus:ring-cyan-500'>
                                Cantidad de Estudiantes <ChevronDownIcon className="w-6 h-6 text-gray-500" />
                            </p>
                        </div>

                        <div className='flex items-center  max-sm:flex-col gap-8 mt-6'>
