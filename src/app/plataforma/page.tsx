"use client"
import {
    Select, SelectItem, Divider, Pagination as Pagination1, Input, useDisclosure, Modal,
...
import CourseCardTienda from "@/components/ui/coursecardtienda";
...
import CompraRapida from "@/components/ui/compraRapida/payment-flow";
import { Download, Phone, ChevronLeft, ChevronRight, X, Bell, ShoppingCart } from 'lucide-react'
import Loaderinicioplataforma from '@/components/ui/plataforma/loader/loader-inicioplataforma';
import Image from 'next/image';
import PopoverStruc from "@/components/ui/PopoverStruc";
    ...
    const slides = [
        {
            ...
            description:
                "El módulo de inicio es una cálida bienvenida a la plataforma, diseñada para guiar a los nuevos usuarios a través de las funcionalidades clave de la aplicación. Al iniciar, se ofrece un tutorial interactivo que explica cómo navegar por los diferentes módulos y aprovechar al máximo las herramientas disponibles. Además, en la sección Conocer más, los usuarios pueden ver un video informativo sobre CCD, la empresa detrás de la plataforma, que destaca su misión, visión y los valores que la impulsan. Este módulo también presenta una selección aleatoria de cursos disponibles para la venta, brindando una visión general de las opciones de aprendizaje que se pueden explorar. Es el punto de partida ideal para familiarizarse con la plataforma y descubrir las oportunidades de formación que ofrece.",
            image: "/Multimedia/modulo/modulo-inicio.png",
        },
        {
            title: "Módulo de mis cursos y diplomas",
            description:
                "Pon a prueba tus conocimientos con evaluaciones personalizadas y obtén certificaciones reconocidas en tu industria.",
            image: "/placeholder.svg?height=300&width=500",
        },
        {
            title: "Módulo de diplomas",
            description:
                "Biblioteca completa de documentos, videos y herramientas para complementar tu formación profesional.",
            image: "/placeholder.svg?height=300&width=500",
        },
        {
        ...
        <>
            ...
            <div className='py-5 px-10 !overflow-visible'>
                <h1 className="text-white text-2xl">
                    Hola,
                     {/* {capitalizeWords(`${session?.user.Nombres} ${session?.user.Apellidos}`)} */}
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-50 backdrop-blur-sm animate-fadeIn">
                    <div className="bg-gradient-to-br from-[#0a2a5e] to-[#051530] w-11/12 max-w-4xl rounded-2xl relative p-8 shadow-2xl animate-slideUp">
                        <button
                            onClick={closeModal}
                        ...
                        <div className="relative overflow-hidden">
                                ...
                                {slides.map((slide, index) => (
                                    <div key={index} className="min-w-full px-4">
                                        <div className="flex flex-col items-center">
                                            <h2 className="text-3xl font-bold text-center !mb-[1.5rem] text-white">{slide.title}</h2>
                                            ...
                                            <p className="text-start text-white/90 max-w-2xl text-lg leading-relaxed">{slide.description}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                            ...
                            <button
                                onClick={prevSlide}
                                className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-sm"
                            >
                                <ChevronLeft size={24} />
                            </button>
                            ...
                            <button
                                onClick={nextSlide}
                                className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-sm"
                            >
                            ...
                            <div className="flex justify-center gap-2 mt-8">
                                {slides.map((_, index) => (
                                    <button
                                        ...
                                        className={`w-3 h-3 rounded-full transition-all duration-300 ${currentSlide === index ? "bg-white scale-125" : "bg-white/30"
                                            }`}
                                    />
                                ))}
                            </div>
                        ...
                        <div className="relative overflow-hidden">
                            <div className="flex transition-transform duration-500 ease-in-out">
                                    ...
                                    <div  className="min-w-full px-4">
                                        <div className="flex flex-col items-center">
                                            <h2 className="text-3xl font-bold text-center !mb-[1.5rem] text-white">Video referencial</h2>
                                            <div className="relative w-full max-w-lg h-64 mb-8 rounded-xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.3)]">
                                                <video
            ...
            <div className='px-6 bg-[image:var(--newgrad4)]  h-40 rounded-xl py-5 flex flex-col gap-2  mx-10'>
                <h1 className='text-white text-lg bg-white/30 w-[4rem] rounded-2xl text-center'>CCD</h1>
                ...
                <div className='flex gap-4 max-sm:justify-between'>
                    ...
                    <Button className="px-6 py-3 bg-white/30 text-white rounded-xl hover:bg-[var(--colorccd1) transition-colors"
                     onClick={openModal1}>
                        Conocer más
                    </Button>
                </div>
                            ...
                            <div className="mx-auto max-w-7xl">
                                    ...
                                    <div className="flex flex-col gap-2 ">
                                        ...
                                        <div className="">
                                            ...
                                            <div className="flex flex-wrap gap-4 mt-4">
                                                <div className="flex items-center gap-2 bg-[var(--colorccd1)/10 text-blue-400 px-4 py-2 rounded-lg hover:bg-[var(--colorccd1)/20 transition-colors cursor-pointer">
                               ...
                               from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-6 py-3
                                 font-medium transition-all hover:shadow-lg hover:shadow-emerald-500/25"
                                            ...
                                            <div className=" pt-6">
                                                <div className="flex flex-col p-4 sm:flex-row items-end justify-between gap-4">
            ...
            <PopoverStruc img='https://pub-9d2abfa175714e64aed33b90722a9fd5.r2.dev/Multimedia/Imagen/Ccd/Promociones/popUpModal.png'/>         
        </>
    )
}