  ...
  return (
    <>
      <div className='flex  justify-between items-center py-3 px-10'>
        ...
        {psala && (<div className='bg-[#141D31] w-[20%] overflow-auto flex flex-col justify-center items-center rounded-xl p-1 gap-3  border-1 border-[#334155]'>
          <Snippet symbol="Sala:" color="primary" variant="solid" className='text-tiny text-white bg-[var(--colorccd1)] !mx-3 !py-0.5 !px-1.5'
      ...
      <Tabs aria-label="Tabs variants" className='px-10'
        ...
        variant={'solid'} classNames={{ "tabList": "!bg-[var(--colorccd3)] border-[var(--colorccd1)] border-1", "cursor": "bg-[var(--colorccd1)] ", "tabContent": "!text-white" }}
      >
                  ...
                  <div className="w-[90%] mx-auto relative z-10">
                    <div className="space-y-12">
                      ...
                      <div className="space-y-4 text-center">
                        <h1 className="text-5xl  font-bold tracking-tight bg-gradient-to-r from-[#00FFFF] via-[#007AFD] to-[#00FFFF] bg-clip-text text-transparent">
                          ¡Bienvenido al curso!
                        </h1>
                        <h2 className="text-xl text-blue-200 font-medium text-start">
                      ...
                      {/* Course Components */}
                      <div className="bg-[var(--colorccd3)] rounded-3xl p-8 space-y-8 shadow-2xl border border-blue-500/20 backdrop-blur-sm bg-opacity-80">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                          {/* PDF Section */}
                          <div className="bg-gradient-to-br from-blue-900/50 to-[#09283C] p-6 rounded-2xl shadow-lg hover:shadow-blue-500/20 transition-all duration-300 group">
                            ...
                            <p className="text-blue-100">
                              Puede descargar las diapositivas y leerlas en cualquier momento.
                            </p>
                          </div>
                          ...
                          <div className="bg-gradient-to-br from-blue-900/50 to-[#09283C] p-6 rounded-2xl shadow-lg hover:shadow-blue-500/20 transition-all duration-300 group">
                            ...
                            <p className="text-purple-100">
                              Videos de las clases en vivo con la explicación del docente de las diapositivas presentadas.
                              Todos los videos tienen la opción para ver en Pantalla Completa.
                            </p>
                          </div>

                          {/* Exams Section */}
                          <div className="md:col-span-2 bg-gradient-to-br from-blue-900/50 to-[#09283C] p-6 rounded-2xl shadow-lg hover:shadow-blue-500/20 transition-all duration-300">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                              <div className="bg-[var(--colorccd1)/30 p-4 rounded-xl border border-blue-500/20">
                                ...
                                <p className="text-blue-100">
                                  Examen de preguntas y respuestas para marcar. La nota mínima aprobatoria es 14/20
                                </p>
                              </div>
                              <div className="bg-[var(--colorccd1)/30 p-4 rounded-xl border border-blue-500/20">
                                <h4 className="font-medium text-blue-300 flex items-center mb-2">
                              ...
                              >
                                {modulo.adjuntos
                                  ...
                                  .map((item: any, temaIndex: number) => {
                                    // Construir la URL correcta según el tipo de archivo
                                    ...
                                    return (
                                      <a
                                        ...
                                        download={item.tipo !== 'Pdf'} // Solo permitir descarga si NO es PDF
                                        target="_blank"
