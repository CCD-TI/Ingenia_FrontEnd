...
export default function Page({ params }: Props) {
  ...
  return (
    <div className="my-6 flex flex-col gap-8">
      ...
      <Pagination1 showControls initialPage={1} total={totalPages} className='mt-[4.5rem]'
                    ...
                    <div className="">
                      ...
                      <div className='mt-[0.7rem] flex flex-col gap-1'>
                        ...
                        {selectedCourse.MarcasRespaldo.includes('2') && (<div className='flex gap-3 items-center'>
                          <Image
                            src={storageUrl + '/Multimedia/Imagen/Ccd/Logos/logocel.png'}
                            alt="Certification Badge"
                            width={40}
                            height={40}
                            className="rounded-full" />
                        ...
                        {selectedCourse.MarcasRespaldo.includes('3') && (<div className='flex gap-3 items-center'>
                          <Image
                            src={storageUrl + '/Multimedia/Imagen/Ccd/Logos/logoautodesk.png'}
                            alt="Certification Badge"
                            width={40}
                            height={40}
                            className="rounded-full" />
                        ...
                        {selectedCourse.MarcasRespaldo.includes('4') && (<div className='flex gap-3 items-center'>
                          <Image
                            src={storageUrl + '/Multimedia/Imagen/Ccd/Logos/logopmi.png'}
                            alt="Certification Badge"
                            width={40}
                            height={40}
                            className="rounded-full" />
