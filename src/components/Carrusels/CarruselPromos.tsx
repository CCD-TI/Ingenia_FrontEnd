...
const imageItems = [
  "https://pub-3d37c601c64a44ff8ec0a62bc03016eb.r2.dev/Ejemplos/CCD%20DAYS%202x1.png",
  "https://pub-3d37c601c64a44ff8ec0a62bc03016eb.r2.dev/Ejemplos/S_20%20dto%20PLIN.jpeg",
  "https://pub-3d37c601c64a44ff8ec0a62bc03016eb.r2.dev/Ejemplos/cuponinternacional.jpg",
  "https://pub-3d37c601c64a44ff8ec0a62bc03016eb.r2.dev/Ejemplos/refiereaunamigo.png",
  "https://pub-3d37c601c64a44ff8ec0a62bc03016eb.r2.dev/Ejemplos/refiereaunamigo.png",
];
...
const CustomNextArrow = ({
  ...
  <>
      ...
      <button
        className="absolute top-[50%] right-0 max-sm:left-[1rem] transform -translate-y-1/2  bg-white/30  p-2 rounded-full z-10 focus:outline-none border border-slate-400"
        onClick={onClick}
      >
        <svg
