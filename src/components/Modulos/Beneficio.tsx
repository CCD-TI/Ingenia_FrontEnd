    ...
    >
      <div className="max-w-[100rem] h-full mx-auto flex flex-col justify-center items-center gap-6 py-24">
        <div className="flex items-center gap-4 w-full max-sm:flex-col">
          <div className="w-[40%] h-1.5  bg-white max-sm:w-36"></div>
          <h1 className="text-[53px] font-poppins font-bold text-white drop-shadow-[0_0_10px_rgba(255,255,255,2)]">
            Membresías
          </h1>
          <div className="w-[40%] h-1.5 bg-white max-sm:w-36"></div>
        </div>
        ...
        <div className="text-5xl !text-white flex items-center gap-3 max-lg:flex-col">
          <span className="font-poppins font-normal"> Aprovecha el</span>
                ...
                <div className="bg-gradient-to-t from-cyan-900 via-cyan-600 to-cyan-400  flex items-center border-3 border-white text-white size-full rounded-3xl">
                  <div className="w-[80%] mx-auto flex flex-col justify-center items-center gap-6 pt-6">
                    ...
                    <div className="flex items-start gap-1 ">
                      <FaCheck className="text-2xl" />
                      <h1 className="text-base max-sm:text-sm">
                        Acceso a todos los libros virtuales y Clases en vivo de
                        todos los cursos por 30 dias
                      </h1>
                    </div>
                    <div className="flex items-start gap-1 ">
                      <FaCheck className="text-2xl" />
                ...
                <div className=" bg-gradient-to-b from-amber-400 via-amber-500 to-amber-700 rounded-3xl flex items-center  size-full gap-6 border-3 border-white text-white">
                  <div className="w-[80%] h-fit mx-auto flex flex-col justify-center items-center gap-6 pt-6  ">
                    ...
                    <div className="flex items-start gap-1 ">
                      <FaCheck className="text-2xl " />
                      <h1 className="text-base max-sm:text-sm">
                        Acceso a mas de 800 ejercicios y 850 ejercicios y 850
                        videos explicativos
                      </h1>
                    </div>
                  ...
                  <div className="w-[80%] h-fit mx-auto flex flex-col justify-center items-center gap-6 pt-6 rounded-3xl">
                    ...
                    <div className="flex items-start gap-1 ">
                      ...
                      <h1 className="text-base w-[90%] max-sm:text-sm">
                        Acceso a todos los libros virtual y clases en vivo por
                        12 meses
                      </h1>
                    </div>
                    <div className="flex items-start gap-1 ">
                      <FaCheck className="text-2xl w-[10%]" />
                      <h1 className="text-base w-[90%] max-sm:text-sm">
                        Acceso a más de 6000 ejercicios y 6000 videos
                        explicativos
                      </h1>
                    </div>
