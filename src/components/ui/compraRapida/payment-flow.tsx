              ...
              if (response.status === 200) {
                ...
                MySwal.fire({
                  ...
                  if (result.isConfirmed) {
                    const listarTemario = await api.post("/inicio/asignarcursoadminv2", {
                        ...
                        <div class="container">
                          ...
                          <div class="content">
                            ...
                            <div class="product-info">
                              <p><strong>Producto:</strong> ${curso}</p>
                  ...
                  const mensaje2 = `<!DOCTYPE html>
                    <html lang="es">
                      ...
                      <body>
                        <div class="container">
                          <header class="header">
                            <img src="https://  DOMINIO  /Multimedia/Imagen/Ccd/Logos/CCDLOGOWHITE.png" alt="logo" class="logo" />
                          ...
                          <div class="content">
                            ...
                            <div class="product-info">
                              ...
                              <p><strong>Correo del usuario:</strong> 
                              CORREO
                              </p>
                              <p><strong>Curso adquirido:</strong> 
                              CURSO
                              </p>
                              <p><strong>Monto pagado:</strong> S/ 
                              PRECIO
                              </p>
              ...
              >
                ...
                <div className="">
                  <h1 className="flex gap-4 items-center">
                    <span className="text-xl"> {tipocurso}</span>
                    <span className="text-colors-cyan-ccd text-2xl">|</span>
                    {modalidad == "En Vivo" ? (
                      <>
                        <span className="text-sm font-medium text-[#00EADE]">
                          Curso En Vivo
                        </span>{" "}
                        <RiBroadcastFill size={20} className="text-[#00EADE]" />
                      </>
                    ) : (
                      <>
                        <span className="text-sm font-medium text-[#00EADE]">
